...
const Aboutpage = () => {
  ...
  const cards = [
    {
      description:
        'The Subscriber Management System provides multi-level reseller management and revenue sharing with all the stakeholders and also includes enhanced CRM features for customer satisfaction. Android and IOS mobile Apps for subscription management and instant activations.',
      image: "/lko.png",
    },
    {
      description:
    ...
    {
      description:
        'The system is built on a robust Linux operating system. The application and database servers can be independently hosted for scalability. Realtime scalable options like Openstack and Kubernetes can be deployed for unlimited expansion.',
      image: "/links.png",
    },
    {
      description:
    ...
    {
      description:
        'DRM does not have any facility to activate and deactivate a Subscriber directly from the Graphical User Interface (GUI) terminal of DRM. All activation, deactivations, bouquets, and channel assignments are done only in SMS and the data is pushed to the DRM server.',
      image: "/lio.png",
    },
    {
      description:
