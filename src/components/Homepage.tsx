...
//     {/* <div className="bg-gradient-to-r from-blue-100 to-yellow-50 w-full p-10 rounded-lg shadow-lg relative w-full flex items-center justify-center mt-[2rem] mb-[3rem]">        
//       <div className="relative w-full h-[15rem] sm:h-[20rem] md:h-[25rem] lg:h-[30rem] xl:h-[75rem] flex items-center justify-center px-8 sm:px-8">
//       <Image
//         src="/recastlogos.png"
//         alt="Facility Image"
//         layout="fill"
...
//               </div>
//               <div className="flex justify-center items-center">
//                 <Image src="/1629530387244MazhavilManorama.jpg" alt="SWSA" width={150} height={150} className="object-contain" />
//               </div>
//               <div className="flex justify-center items-center">
...
//               </div>
//               <div className="flex justify-center items-center">
//                 <Image src="/1629270857707DDNATIONALHD.jpg" alt="ETVHD" width={100} height={100} className="object-contain" />
//               </div>
//               <div className="flex justify-center items-center">
...
//               </div>
//               <div className="flex justify-center items-center">
//                 <Image src="/1629533473258abpMAJHA.jpg" alt="SWSA" width={100} height={100} className="object-contain" />
//               </div>
//               <div className="flex justify-center items-center">
...
//               </div>
//               <div className="flex justify-center items-center">
//                 <Image src="/1697621408866B4UMovies.png" alt="ETVHD" width={100} height={100} className="object-contain" />
//               </div>
//             </div>

//             <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-12 gap-6 mt-10">
//               <div className="flex justify-center items-center">
//                 <Image src="/1629353193379DISCOVERYHD.jpg" alt="Physician" width={150} height={150} className="object-contain" />
//               </div>
//               <div className="flex justify-center items-center">
//                 <Image src="/1680096465676DisneyChannelHD441.jpg" alt="SWSA" width={70} height={70} className="object-contain" />
//               </div>
//               <div className="flex justify-center items-center">
...
//               </div>
//               <div className="flex justify-center items-center">
//                 <Image src="/CNNNEWS18.png" alt="ZEETVHD" width={150} height={150} className="object-contain" />
//               </div>
//               <div className="flex justify-center items-center">
...
//                    className="text-white text-lg font-medium px-4 py-2 border bg-[#0a0f2c] border-blue-500 rounded-lg hover:bg-blue-500 hover:text-white transition duration-300"
//                  >
//                    Read More
//                  </button>
//                </div>
...
{/* 
        <div className="flex justify-center space-x-8">
          ...
          <li className="px-8 py-4 text-xl font-bold text-white bg-red-500 rounded-xl hover:bg-[#0a0f2c] cursor-pointer hover:text-[#F7961E] py-2 px-4 md:py-0 md:px-0">
